      ...
      <div className="space-y-8 max-w-2xl">
        ...
        <div className="bg-white rounded-2xl p-6 border border-petblue-100 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1.5">Cidade / Estado</label>
          ...
          <button className="mt-5 w-full py-3 rounded-xl bg-petblue-400 text-white font-bold text-sm hover:bg-petblue-500 transition-colors">Salvar alterações</button>
        </div>
        <div className="bg-white rounded-2xl p-6 border border-petblue-100 shadow-sm">
          <h3 className="font-bold text-gray-800 mb-5 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-petblue-400 transition-colors">
                  <option>Cachorro</option><option>Gato</option><option>Pássaro</option><option>Coelho</option><option>Outro</option>
                </select>
              </div>
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1.5">Como está sendo o processo de luto?</label>
              <textarea rows={3} placeholder="Descreva brevemente o que está sentindo..." className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-petblue-400 transition-colors resize-none" />
            </div>
          </div>
          <button className="mt-4 w-full py-3 rounded-xl bg-petblue-400 text-white font-bold text-sm hover:bg-petblue-500 transition-colors">Salvar</button>
        </div>
      </div>
    </DashboardLayout>
  )
