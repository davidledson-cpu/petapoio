...
const MOCK_SESSIONS = [
  {
    id: '1',
    professional: { name: 'Dra. Camila Torres', specialty: 'Luto animal' },
  ...
  {
    id: '2',
    professional: { name: 'Dr. Ricardo Souza', specialty: 'Psicologia clínica' },
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-petblue-400 text-white text-sm font-bold hover:bg-petblue-500 transition-colors"
          >
        ...
        <div>
          ...
          {upcoming.length === 0 ? (
            <div className="bg-white rounded-2xl p-10 text-center border border-petblue-100">
              ...
              <Link href="/dashboard/paciente/profissionais" className="mt-3 inline-block text-petblue-500 font-semibold text-sm hover:underline">
              ...
              {upcoming.map(s => (
                <div key={s.id} className="bg-white rounded-2xl p-5 border border-petblue-100 shadow-sm flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <span className={`text-xs font-bold px-3 py-1 rounded-full ${STATUS_LABELS[s.status].class}`}>
              ...
              <div key={s.id} className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 opacity-80">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-400 mt-0.5">
                    {new Date(s.date).toLocaleString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' })} • {s.duration}min
                  </div>
                </div>
