...
const MOCK_PATIENTS = [
  {
    ...
    status: 'active',
    rating: 5,
    note: 'Luto pela perda de Mel (cachorra, 12 anos)',
    avatar: 'A',
  },
  {
    id: 'pt2',
    ...
    status: 'active',
    rating: 5,
    note: 'Perda repentina de Simba (gato, 8 anos)',
    avatar: 'B',
  },
  {
    id: 'pt3',
    ...
    status: 'active',
    rating: 4,
    note: 'Separação forçada por mudança',
    avatar: 'C',
  },
  {
    id: 'pt4',
    ...
    status: 'new',
    rating: null,
    note: 'Nova paciente — 1ª sessão agendada',
    avatar: 'D',
  },
  {
    id: 'pt5',
    ...
    status: 'active',
    rating: 5,
    note: 'Luto prolongado — acompanhamento contínuo',
    avatar: 'E',
  },
]
    ...
    <DashboardLayout userRole="professional" userName={user.name || 'Profissional'} userAvatar={user.avatar}>
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-2xl border border-petblue-100 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-petblue-50">
            <h3 className="font-bold text-gray-800">Lista de Pacientes</h3>
          </div>
          <div className="divide-y divide-gray-50">
            {MOCK_PATIENTS.map(pt => (
              <div key={pt.id} className="p-5 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                <div className="w-10 h-10 rounded-xl bg-petblue-100 flex items-center justify-center font-bold text-petblue-600 flex-shrink-0">
                  {pt.avatar}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {pt.status === 'new' && (
                      <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-petblue-100 text-petblue-600">Novo</span>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <button className="p-2 rounded-lg hover:bg-petblue-50 text-gray-400 hover:text-petblue-500 transition-colors">
