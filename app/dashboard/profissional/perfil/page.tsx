        ...
        <div className="bg-white rounded-2xl p-6 border border-petblue-100 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea rows={4} defaultValue="Especialista em luto por perda de animais de estimação. Mais de 10 anos de experiência em apoio emocional para tutores que atravessam este momento difícil." className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-petblue-400 transition-colors resize-none" />
            </div>
          </div>
        </div>
        <div className="bg-white rounded-2xl p-6 border border-petblue-100 shadow-sm">
        ...
        <div className="bg-white rounded-2xl p-6 border border-petblue-100 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-petblue-400 transition-colors">
                <option>50 minutos</option><option>60 minutos</option><option>45 minutos</option>
              </select>
            </div>
          </div>
        </div>
        <button className="w-full py-3.5 rounded-xl bg-petblue-400 text-white font-bold hover:bg-petblue-500 transition-colors">Salvar perfil</button>
      </div>
    </DashboardLayout>
  )
}