          ...
          {step === 1 && (
            <>
              ...
              <form onSubmit={form1.handleSubmit(onStep1)} className="space-y-5">
                ...
                <button type="submit" className="w-full py-3.5 rounded-xl bg-petblue-400 text-white font-bold text-sm hover:bg-petblue-500 transition-colors flex items-center justify-center gap-2">
